...
define(function(require, exports, module) {
    ...
    if (!sessionStorage.getItem('popover')) {
        ...
        sessionStorage.setItem('popover', 1);
    }
    ...
    $(function() {
        ...
        var bgWindow = safari.extension.globalPage.contentWindow; //chrome.extension.getBackgroundPage();
                ...
                if (!islogin) {
                    ...
                    Login.getToken(function(token) {
                        ...
                        Login.getUin(function(uin) {
                            console.log("uin:" + uin);
                            if (localStorage.getItem('uin') && uin == localStorage.getItem('uin') && localStorage.getItem('face')) {
