...
define(function(require, exports, module) {
    ...
    SQL['trailer'] = {
        ...
        'select': 'select * from {0} order by id desc \
                limit {1}',
    ...
    SQL['activity'] = {
        ...
        'update_read_all': 'update {0} set is_read = 1',
        //查询messages表中的数据
        'select_messages': 'select * from {0}  where flag = {1} order by id desc limit {2}',
        //查询messages表中所有的数据
        'select_all_messages': 'select * from {0} order by id desc limit {1}',
        //更新messages表中数据
        'update_messages': 'update {0} set flag = {1} where id = {2}',
        //删除messages表中数据
        'delete': 'delete from {0} where id = {1}',
